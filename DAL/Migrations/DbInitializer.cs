...
namespace DAL.Migrations
{
    public class DbInitializer
    {
        ...
        {
            context.Usuario.Add(new ENT.Ent.Usuario { Usr = "admin", Pasword = MD5.CreateMD5("#MiPass123456") });
            context.SaveChanges();
        }
        ...
        public static void SeedTblDiscapacidad(MyDBContext context)
        {
            context.TblDiscapacidad.AddRange(
                        new List<ENT.Ent.TblDiscapacidad> {
                        new ENT.Ent.TblDiscapacidad{ Descripcion="Discapacidad física"},
                        new ENT.Ent.TblDiscapacidad{ Descripcion="Discapacidad sensorial"},
                        new ENT.Ent.TblDiscapacidad{ Descripcion="Discapacidad intelectual"},
                        new ENT.Ent.TblDiscapacidad{ Descripcion="Discapacidad psíquica"},
                        new ENT.Ent.TblDiscapacidad{ Descripcion="Discapacidad múltiple."},
        ...
        public static void SeedTblEstratoSocioEconomico(MyDBContext context)
        {
            context.TblEstratoSocioEconomico.AddRange(
                        new List<ENT.Ent.TblEstratoSocioEconomico> {
                        new ENT.Ent.TblEstratoSocioEconomico{ Descripcion="Estrato 1"},
                        new ENT.Ent.TblEstratoSocioEconomico{ Descripcion="Estrato 2"},
                        new ENT.Ent.TblEstratoSocioEconomico{ Descripcion="Estrato 3"},
                        new ENT.Ent.TblEstratoSocioEconomico{ Descripcion="Estrato 4"},
                        new ENT.Ent.TblEstratoSocioEconomico{ Descripcion="Estrato 5"},
                        new ENT.Ent.TblEstratoSocioEconomico{ Descripcion="Estrato 6"},
                        });
            context.SaveChanges();
        }
        public static void SeedTblEtnia(MyDBContext context)
        {
            context.TblEtnia.AddRange(
                        new List<ENT.Ent.TblEtnia> {
                        new ENT.Ent.TblEtnia{ Descripcion="Indígenas"},
                        new ENT.Ent.TblEtnia{ Descripcion="Raizal"},
                        new ENT.Ent.TblEtnia{ Descripcion="Rom"},
                        new ENT.Ent.TblEtnia{ Descripcion="Afrodescendiente"},
                        new ENT.Ent.TblEtnia{ Descripcion="Palenquera"},
                        new ENT.Ent.TblEtnia{ Descripcion="Ninguna"},
                        });
            context.SaveChanges();
        }
        public static void SeedTblGenero(MyDBContext context)
        {
            context.TblGenero.AddRange(
                        new List<ENT.Ent.TblGenero> {
                        new ENT.Ent.TblGenero{ Descripcion="Hombre"},
                        new ENT.Ent.TblGenero{ Descripcion="Mujer"},
                        new ENT.Ent.TblGenero{ Descripcion="No Binario"},
                        });
            context.SaveChanges();
        }
        public static void SeedTblOrientacion(MyDBContext context)
        {
            context.TblOrientacion.AddRange(
                        new List<ENT.Ent.TblOrientacion> {
                        new ENT.Ent.TblOrientacion{ Descripcion="Heterosexualidad"},
                        new ENT.Ent.TblOrientacion{ Descripcion="Homosexualidad"},
                        new ENT.Ent.TblOrientacion{ Descripcion=" Bisexualidad"},
                        new ENT.Ent.TblOrientacion{ Descripcion="Demisexualidad"},
                        new ENT.Ent.TblOrientacion{ Descripcion="Pansexualdiad"},
                        new ENT.Ent.TblOrientacion{ Descripcion="Autosexualidad"},
                        new ENT.Ent.TblOrientacion{ Descripcion="Lithsexualidad"},
                        new ENT.Ent.TblOrientacion{ Descripcion="Asexualidad"},
                        new ENT.Ent.TblOrientacion{ Descripcion="Polisexualidad"},
                        new ENT.Ent.TblOrientacion{ Descripcion=" Antrosexualidad"},
                        });
            context.SaveChanges();
        }
        public static void SeedTblIdentidaDeGenero(MyDBContext context)
        {
            context.TblIdentidaDeGenero.AddRange(
                        new List<ENT.Ent.TblIdentidaDeGenero> {
                        new ENT.Ent.TblIdentidaDeGenero{ Descripcion="Cisgenero"},
                        new ENT.Ent.TblIdentidaDeGenero{ Descripcion="Transgenero"},
                        });
            context.SaveChanges();
        }
        public static void SeedTblJornadaDeTrabajo(MyDBContext context)
        {
            context.TblJornadaDeTrabajo.AddRange(
                        new List<ENT.Ent.TblJornadaDeTrabajo> {
                        new ENT.Ent.TblJornadaDeTrabajo{ Descripcion="Medio Tiempo"},
                        new ENT.Ent.TblJornadaDeTrabajo{ Descripcion="Tiempo Completo"},
                        new ENT.Ent.TblJornadaDeTrabajo{ Descripcion="Por horas"},
                        new ENT.Ent.TblJornadaDeTrabajo{ Descripcion="Fines de Semana"},
                        });
            context.SaveChanges();
        }
        public static void SeedTblLocalidadTrabaja(MyDBContext context)
        {
            context.TblLocalidadTrabaja.AddRange(
                        new List<ENT.Ent.TblLocalidadTrabaja> {
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Usaquén"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Chapinero"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Santafe"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="San Cristóbal"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Usme"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Tunjuelito"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Bosa"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Kennedy"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Fontibón"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Engativa"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Suba"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Barrios Unidos"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Teusaquillo"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Mártires"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Antonio Nariño"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Puente Aranda"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="La Candelaria"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Rafael Uribe Uribe"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Ciudad Bolívar"},
                        new ENT.Ent.TblLocalidadTrabaja{ Descripcion="Sumapaz"},
                        });
            context.SaveChanges();
        }

        public static void SeedTblLocalidadVive(MyDBContext context)
        {
            context.TblLocalidadVive.AddRange(
                        new List<ENT.Ent.TblLocalidadVive> {
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Usaquén"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Chapinero"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Santafe"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="San Cristóbal"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Usme"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Tunjuelito"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Bosa"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Kennedy"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Fontibón"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Engativa"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Suba"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Barrios Unidos"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Teusaquillo"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Mártires"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Antonio Nariño"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Puente Aranda"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="La Candelaria"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Rafael Uribe Uribe"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Ciudad Bolívar"},
                        new ENT.Ent.TblLocalidadVive{ Descripcion="Sumapaz"},
                        });
            context.SaveChanges();
        }

        public static void SeedTblNivelDeEscolaridad(MyDBContext context)
        {
            context.TblNivelDeEscolaridad.AddRange(
                        new List<ENT.Ent.TblNivelDeEscolaridad> {
                        new ENT.Ent.TblNivelDeEscolaridad{ Descripcion="Sin educación"},
                        new ENT.Ent.TblNivelDeEscolaridad{ Descripcion="Primaria"},
                        new ENT.Ent.TblNivelDeEscolaridad{ Descripcion="Secundaria"},
                        new ENT.Ent.TblNivelDeEscolaridad{ Descripcion="Tecnico"},
                        new ENT.Ent.TblNivelDeEscolaridad{ Descripcion="Tecnólogo"},
                        new ENT.Ent.TblNivelDeEscolaridad{ Descripcion="Profesional"},
                        new ENT.Ent.TblNivelDeEscolaridad{ Descripcion="Especialización"},
                        });
            context.SaveChanges();
        }
        public static void SeedTblSeguridadSocial(MyDBContext context)
        {
            context.TblSeguridadSocial.AddRange(
                        new List<ENT.Ent.TblSeguridadSocial> {
                        new ENT.Ent.TblSeguridadSocial{ Descripcion="Subsidiado"},
                        new ENT.Ent.TblSeguridadSocial{ Descripcion="Contributivo"},
                        });
            context.SaveChanges();
        }
        public static void SeedTblSubsidio(MyDBContext context)
        {
            context.TblSubsidio.AddRange(
                        new List<ENT.Ent.TblSubsidio> {
                        new ENT.Ent.TblSubsidio{ Descripcion="Colombia Mayor"},
                        new ENT.Ent.TblSubsidio{ Descripcion="Bogota Solidaria en Casa"},
                        new ENT.Ent.TblSubsidio{ Descripcion="Bono C"},
                        new ENT.Ent.TblSubsidio{ Descripcion="Bono adulto Mayor"},
                        new ENT.Ent.TblSubsidio{ Descripcion="Bono de Discapacidad"},
                        });
            context.SaveChanges();
        }
        public static void SeedTblTipoDeVivienda(MyDBContext context)
        {
            context.TblTipoDeVivienda.AddRange(
                        new List<ENT.Ent.TblTipoDeVivienda> {
                        new ENT.Ent.TblTipoDeVivienda{ Descripcion="Habitación"},
                        new ENT.Ent.TblTipoDeVivienda{ Descripcion="Apto"},
                        new ENT.Ent.TblTipoDeVivienda{ Descripcion="Casa"},
                        new ENT.Ent.TblTipoDeVivienda{ Descripcion="Pagadiario"},
                        });
            context.SaveChanges();
        }
        public static void SeedTblTipoDocumento(MyDBContext context)
        {
            context.TblTipoDocumento.AddRange(
                        new List<ENT.Ent.TblTipoDocumento> {
                        new ENT.Ent.TblTipoDocumento{ Descripcion="Cedula"},
                        new ENT.Ent.TblTipoDocumento{ Descripcion="Cédula de Extranjería"},
                        new ENT.Ent.TblTipoDocumento{ Descripcion="Cédula de Extranjería"},
                        });
            context.SaveChanges();
        }
